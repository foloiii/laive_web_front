      ...
      <div className={`relative z-10 max-w-4xl text-center space-y-6 transition-all duration-700 transform ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
        <div className="flex justify-center">
          <span className="inline-flex items-center gap-2 px-3 py-1 text-xs font-medium rounded-full bg-muted text-primary">
            ...
            AI assistant now live in meetings
            <Loader className="h-3 w-3 animate-spin text-primary" />
          </span>
        </div>

        <h1 className="text-4xl md:text-6xl lg:text-7xl font-medium tracking-tighter text-balance text-foreground">
          AI-powered refinement meetings for <span className="text-foreground">smarter</span> product teams
        </h1>

        <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto text-balance">
          Never miss important questions again. Our AI assistant listens to your meetings and suggests the most relevant questions in real-time, reducing refinement time by 20%.
        </p>
        ...
        <div className="pt-6 text-sm text-muted-foreground">
          No credit card required • 5 hours free monthly
        </div>
      </div>
          ...
          <div className="bg-card backdrop-blur-md w-full">
            <div className="flex items-center justify-between p-4 border-b border-border">
              <div className="flex items-center gap-4">
                ...
                <span className="text-foreground font-medium">Laive</span>
              </div>
              ...
              <div className="flex-1 p-4 bg-background overflow-hidden">
                ...
                <div className="flex items-center justify-between mb-6 min-w-0">
                  <div className="flex items-center gap-2 flex-shrink-0">
                    ...
                    <span className="text-xs bg-muted px-2 py-1 rounded-full text-muted-foreground">1</span>
                  </div>
